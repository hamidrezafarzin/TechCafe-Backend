...
class Ticket:
    ...
    def add(self, title, content, aws=True):
        data = {"title": title, "content": content, "alertWithSms": aws}
    ...
    def get_received(self, ticketOwner, ticketType, keyword):
        ...
        result = self.client.service.GetReceivedTickets(**self.get_data(), **data)
        return result
    ...
    def get_received_count(self, ticketType):
        ...
        result = self.client.service.GetReceivedTicketsCount(**self.get_data(), **data)
        return result
    ...
    def get_sent_count(self, ticketType):
        ...
        result = self.client.service.GetSentTicketsCount(**self.get_data(), **data)
        return result
